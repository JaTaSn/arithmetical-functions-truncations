...
to help him complete EGA, I have Claude! What exactly that amounted to is set
out in the disclosure section below.
...
\seqnum{A182843}; Theorem \ref{thm:error} together with Lemma
\ref{lem:semiprime} and the two cautions of Remark \ref{rem:buchstab-trap}; and
the contents of Section \ref{sec:socle}. Claude also located and verified the
references, drew Figure \ref{fig:profile}, wrote the accompanying
