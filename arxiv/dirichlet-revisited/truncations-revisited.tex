...
%     one published article, and the entries now say which part each became.  JAN TO CONFIRM the
%     first-part/second-part attribution, which is inferred from that review's structure.  Also:
...
% NOTE (2026-08-30): the two entries below are two distinct arXiv preprints -- different
% identifiers, different submission dates (2002-05-23 and 2002-08-23), different titles and
% abstracts, verified against the deposited PDFs -- that were published together as a SINGLE
% article.  An earlier version of this bibliography gave each of them the journal reference
% "Int. J. Math. Game Theory Algebra 13 (2003), no. 6, 485-519", which cannot be right for two
% separate papers, and attributed that claim to arXiv's metadata.  arXiv sets no journal-ref on
% either record.  zbMATH has exactly one published item (Zbl 1165.11301), whose review summary
% treats the general-V case first and the V = [n] case "in the second part", and which links only
% arXiv:math/0205242.  Hence the "first part"/"second part" wording below.
\bibitem[Sne03a]{SnellmanUnitaryGeneral}
Jan Snellman,
\emph{The ring of arithmetical functions with unitary convolution: general
truncations},
arXiv:math/0205242; published as the first part of
\emph{Truncations of the ring of arithmetical functions with unitary convolution},
Int. J. Math. Game Theory Algebra \textbf{13} (2003), no.~6, 485--519; Zbl 1165.11301.

\bibitem[Sne03b]{SnellmanUnitaryN}
Jan Snellman,
\emph{The ring of arithmetical functions with unitary convolution: the
\([n]\)-truncation},
arXiv:math/0208183; published as the second part of
\emph{Truncations of the ring of arithmetical functions with unitary convolution},
Int. J. Math. Game Theory Algebra \textbf{13} (2003), no.~6, 485--519; Zbl 1165.11301.
